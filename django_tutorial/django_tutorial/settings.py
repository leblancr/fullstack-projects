...
if ENV == "production":
    ALLOWED_HOSTS = ["django_tutorial-0c2z.onrender.com"]
...
# DEBUG should follow the environment detection
...
STATIC_URL = '/static/'  # css files
# Static files (Render collects these)
